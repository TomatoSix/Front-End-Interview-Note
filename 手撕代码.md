...
30. promise 的一些问题
    ...
    2. then 的返回结果
       ...
       2. return 一个非 promise 对象, 例如 return 123 , result 为成功的 promise
       3. return 一个 promise 对象
       4. 没有 return , 因为没有返回值
...
47. JSON2DOM 函数-虚拟 DOM 转为真实 DOM
...
49. 怎么在制定数据源里面生成一个长度为 n 的不重复随机数组 能有几种方法 时间复杂度多少（字节）
...
54. 以广度优先搜索 dom 树返回第一个 className 为 container 的 dom 节点
